...
def test_initialize_population(df_X_train):
    ...
    algo_object=GravitationalOptimization(objective_function_topass)
...
def test_fit(df_model, df_X_train, df_y_train, df_X_valid, df_y_valid):
    ...
    algo_object=GravitationalOptimization(objective_function_topass,n_iteration=5,timeout=60*60)
